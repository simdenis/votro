...
PROMPT = (
    ...
    "- prioritizează justificarea CONCRETĂ — decizii ale instanțelor, cifre, "
    "probleme specifice invocate, obligații externe (CCR, CEDO, directive UE, "
    "PNRR) — în locul formulărilor generice de tip „consolidare și modernizare” "
    "sau „îmbunătățirea cadrului legislativ”; dacă expunerea conține și "
    "motivare specifică, și formulări generice, extrage-o pe cea specifică\n"
