...
PROMPT = (
    ...
    "textul prin care INIȚIATORII își susțin propunerea (nu o analiză neutră). "
    "Descrie pe scurt, pentru un cetățean obișnuit fără studii juridice, CE AR SCHIMBA "
    "CONCRET acest proiect — ce ar face legea diferit față de acum. Reguli:\n"
    ...
    "- DESCRIE ce face proiectul; NU argumenta că e bun, necesar sau util. Nu prelua "
    "ca fapt scopurile, beneficiile sau justificările invocate de inițiatori\n"
    "- INTERZIS: fraze care pledează pentru lege („este important”, „astfel încât să "
    "avem…”, „asigură că…”, „pentru a proteja…”, „vine în sprijinul…”) și orice adjectiv "
    "de evaluare („controversat”, „binevenit”, „modern”)\n"
    "- INTERZIS și verbele încărcate emoțional sau acuzatoare („forțează”, „obligă "
    "abuziv”, „impune cu forța”, „îngrădește”, „vrea să scape de…”); folosește verbe "
    "neutre care descriu efectul juridic („permite”, „prevede”, „stabilește”, „dispune”, "
    "„elimină”, „amână”)\n"
