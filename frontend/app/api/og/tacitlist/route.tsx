...
export async function GET() {
  ...
  const rows: { code: string; title: string | null; summary: string | null; chamber: string; tacit_deadline: string }[] =
    (await (await fetch(
      `${U}/rest/v1/pending_bills?select=code,title,summary,chamber,tacit_deadline` +
